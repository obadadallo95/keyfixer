...
const content = {
  ...
  ar: {
    title: 'عن المطور',
    role: 'صانع منتجات رقمية بمنهج AI-first ومطور Full-stack',
    bio: 'أحوّل الأفكار الخام إلى منتجات واضحة وقابلة للإطلاق، من تحديد نطاق الـMVP واتجاه المنتج إلى التصميم والتنفيذ الفعلي لتطبيقات الويب والموبايل وأنظمة الأتمتة.',
